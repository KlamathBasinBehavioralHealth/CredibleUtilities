const templateBlock = '<strong>Level of Care</strong> <br>Pathway <div class=\'buttons\' style=\'display:inline;\'><button>1</button>/<button>2</button>/<button>3</button>/<button>4</button></div><br><br><strong>Client Goals</strong>&nbsp<br><em>Client would like to:</em><ol><li></li><li></li><li></li><li></li><li></li></ol><strong>Treatment Objectives</strong>&nbsp<br><em>These goals will be evidenced by the following objectives:</em><ol><li></li><li></li><li></li><li></li><li></li></ol><strong>Services Planned</strong>&nbsp<div id=\'lineTherapy\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Therapy</em></strong> An expected <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button> for the duration of this treatment planpprovided by a QMHP&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'lineTherapyGroup\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Group Therapy</em></strong> An expected <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div>for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button> for the duration of this treatment planpprovided by a QMHP&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'lineCaseManagement\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Case Management</em></strong> An expected <div class=\'numbers\' style=\'display:inline;\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button> for the duration of this treatment planpprovided by a QMHA/QMHP&nbsp(to provide support to increase DLA-20 score)&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'lineSkillsTraining\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Skills Training</em></strong> An expected <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button> for the duration of this treatment planpprovided by a QMHA/QMHP&nbsp(to provide support to increase DLA-20 score)&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'lineSkillsTrainingGroup\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Skills Training Group</em></strong> An expected <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button> for the duration of this treatment planpprovided by a QMHA/QMHP&nbsp(to provide support to increase DLA-20 score)&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'linePeerSupport\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Peer Support</em></strong> An expected <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button> for the duration of this treatment planpprovided by a Peer Support Specialist&nbsp(to provide support to increase DLA-20 score)&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'linePeerSupportGroup\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Peer Support Group</em></strong> An expected <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour</button>/<button>minute</button> for the duration of this treatment planpprovided by a Peer Support Specialist&nbsp(to provide support to increase DLA-20 score)&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><br><strong><em>Healthcare Navigation Support</em></strong> An expected 1x provided by a QMHA/QMHP (to teach the client to navigate behavioral health and community resource systems to address barriers to accessing healthcare)<br><br><strong>Client Participation</strong>&nbsp<br><div id=\'clientParticipation\' class=\'lineDiv\' style=\'display:inline;\'><div class=\'buttons\' style=\'display:inline;\'><button>Client</button>/<button>Client & family</button>/<button>Family</button></div> actively participated in the creation of this treatment plan to determine goals and services.</div><br><br><em>This treatment plan will be reviewed every 180 days.</em><br><br><em><div id=\'seeTIC\' class=\'lineDiv\' style=\'display:inline;\'>See TIC Evaluation dated <div class=\'entry\' style=\'display:inline\'><button>Click to Enter Date</button></div> by <div class=\'entry\' style=\'display:inline\'><button>Click to Enter Name</button></div>, <div class=\'entry\' style=\'display:inline\'><button>Click to Enter Credential(s)</button></div>.</div></em>';

const sudTemplateBlock = '<strong>Level of Care</strong> <br>Level of Care <div class=\'buttons\' style=\'display:inline;\'><button>0.5</button>/<button>1.0</button>/<button>2.1</button>/<button>2.5</button>/<button>3.1</button>/<button>3.3</button>/<button>3.5</button>/<button>3.7</button>/<button>4.0</button></div><br><br><strong>Client Goals</strong>&nbsp<br><em>Client would like to:</em><ol><li></li><li></li><li></li><li></li><li></li></ol><strong>Treatment Objectives</strong>&nbsp<br><em>These goals will be evidenced by the following objectives:</em><ol><li></li><li></li><li></li><li></li><li></li></ol><strong>Services Planned</strong>&nbsp<div id=\'lineSUDCounseling\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>SUD Counseling</em></strong> An expected <div class=\'numbers\' style=\'display:inline;\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button>  the duration of this treatment plan&nbspprovided by a CADC&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'lineSUDGroup\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>SUD Group Counseling</em></strong> An expected <div class=\'numbers\' style=\'display:inline;\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button>  the duration of this treatment plan&nbspprovided by a CADC&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'lineCaseManagement\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Case Management</em></strong> An expected <div class=\'numbers\' style=\'display:inline;\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button>  the duration of this treatment plan&nbspprovided by a CADC&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'linePeerSupport\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Peer Support</em></strong> An expected <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button> for the duration of this treatment plan&nbspprovided by a PSS/CRM&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'linePeerSupportGroup\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Peer Support Group</em></strong> An expected <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button>for the duration of this treatment plan&nbspprovided by a PSS/CRM&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'lineSUDUA\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>SUD UA</em></strong> An expected <div class=\'numbers\' style=\'display:inline;\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button> for the duration of this treatment plan&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><br><strong><em>Healthcare Navigation Support</em></strong> An expected 1x provided by a PSS/CRM (to teach the client to navigate behavioral health and community resource systems to address barriers to accessing healthcare)<br><br><strong>Client Participation</strong>&nbsp<br><div id=\'clientParticipation\' class=\'lineDiv\' style=\'display:inline;\'><div class=\'buttons\' style=\'display:inline;\'><button>Client</button>/<button>Client & family</button>/<button>Family</button></div> actively participated in the creation of this treatment plan to determine goals and services.</div><br><br><em>This treatment plan will be reviewed every 180 days.</em><br><br><em><div id=\'seeTIC\' class=\'lineDiv\' style=\'display:inline;\'>See SUD Assessment dated <div class=\'entry\' style=\'display:inline\'><button>Click to Enter Date</button></div> by <div class=\'entry\' style=\'display:inline\'><button>Click to Enter Name</button></div>, <div class=\'entry\' style=\'display:inline\'><button>Click to Enter Credential(s)</button></div>.</div></em>';

const crisisTemplateBlock = '<strong>Level of Care</strong> <br>Crisis<br><br><strong>Client Goals</strong>&nbsp<br><em>Client would like to:</em><ol><li></li><li></li><li></li><li></li><li></li></ol><strong>Treatment Objectives</strong>&nbsp<br><em>These goals will be evidenced by the following objectives:</em><ol><li></li><li></li><li></li><li></li><li></li></ol><strong>Services Planned</strong>&nbsp<div id=\'lineTherapy\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Therapy</em></strong> An expected <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button> for the duration of this treatment plan provided by&nbspprovided by a QMHP&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'lineTherapyGroup\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Group Therapy</em></strong> An expected <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button> for the duration of this treatment plan provided by&nbspprovided by a QMHP&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'lineCaseManagement\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Case Management</em></strong> An expected <div class=\'numbers\' style=\'display:inline;\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button> for the duration of this treatment plan provided by&nbspprovided by a QMHA/QMHP&nbsp(to provide support to increase DLA-20 score)&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'lineSkillsTraining\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Skills Training</em></strong> An expected <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button> for the duration of this treatment plan provided by&nbspprovided by a QMHA/QMHP&nbsp(to provide support to increase DLA-20 score)&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'lineSkillsTrainingGroup\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Skills Training Group</em></strong> An expected <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button> for the duration of this treatment plan provided by&nbspprovided by a QMHA/QMHP&nbsp(to provide support to increase DLA-20 score)&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'linePeerSupport\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Peer Support</em></strong> An expected <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button> for the duration of this treatment plan provided by&nbspprovided by a PSS&nbsp(to provide support to increase DLA-20 score)&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'linePeerSupportGroup\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Peer Support Group</em></strong> An expected <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button> for the duration of this treatment plan provided by&nbspprovided by a PSS&nbsp(to provide support to increase DLA-20 score)&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'lineFamilySupport\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Family Peer Support</em></strong> An expected <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div> for <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div> <div class=\'buttons\' style=\'display:inline;\'><button>hour(s)</button>/<button>minutes</button> for the duration of this treatment plan provided by&nbspprovided by a PSS&nbsp(to provide family support to assist client in de-escalating mental health symptoms)&nbsp</div><button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><br><br><strong>Client Participation</strong>&nbsp<br><div id=\'clientParticipation\' class=\'lineDiv\' style=\'display:inline;\'><div class=\'buttons\' style=\'display:inline;\'><button>Client</button>/<button>Client & family</button>/<button>Family</button></div> actively participated in the creation of this treatment plan to determine goals and services.</div><br><br><em>This treatment plan will be reviewed every 30 days.</em><br><br><em><div id=\'seeTIC\' class=\'lineDiv\' style=\'display:inline;\'>See Crisis Assessment dated <div class=\'entry\' style=\'display:inline\'><button>Click to Enter Date</button></div> by <div class=\'entry\' style=\'display:inline\'><button>Click to Enter Name</button></div>, <div class=\'entry\' style=\'display:inline\'><button>Click to Enter Credential(s)</button></div>.</div></em>';
