...
const sudTemplateBlock = '<strong>Level of Care</strong> <br>Pathway <div class=\'buttons\' style=\'display:inline;\'><button>0.5</button>/<button>1.0</button>/<button>2.1</button>/<button>2.5</button>/<button>3.1</button>/<button>3.3</button>/<button>3.5</button>/<button>3.7</button>/<button>4.0</button></div><br><br><strong>Client Goals</strong>&nbsp<br><em>Client would like to:</em><ul><li></li><li></li><li></li><li></li><li></li></ul><strong>Treatment Objectives</strong>&nbsp<br><em>These goals will be evidenced by the following objectives:</em><ul><li></li><li></li><li></li><li></li><li></li></ul><strong>Services Planned</strong>&nbsp<div id=\'lineCaseManagement\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Case Management</em></strong> An expected <div class=\'numbers\' style=\'display:inline;\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div>&nbsp<button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'linePeerSupport\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Peer Support</em></strong> An expected <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div>&nbsp<button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><div id=\'linePeerSupportGroup\' class=\'lineDiv\' style=\'display:inline;\'><br><strong><em>Peer Support Group</em></strong> An expected <div class=\'numbers\' style=\'display:inline\'><button>Click to Enter Number</button></div>x per <div class=\'buttons\' style=\'display:inline;\'><button>month</button>/<button>week</button></div>&nbsp<button class=\'clearLine\' style=\'color:white;background-color:red;\'>x</button></div><br><strong><em>Healthcare Navigation Skills Training</em></strong> An expected 1x (to teach the client to navigate behavioral health and community resource systems to address barriers to accessing healthcare)<br><br><strong>Client Participation</strong>&nbsp<br><div id=\'clientParticipation\' class=\'lineDiv\' style=\'display:inline;\'><div class=\'buttons\' style=\'display:inline;\'><button>Client</button>/<button>Client & family</button>/<button>Family</button></div> actively participated in the creation of this treatment plan to determine goals and services.</div><br><br><em>This treatment plan will be reviewed every 180 days.</em><br><br><em><div id=\'seeTIC\' class=\'lineDiv\' style=\'display:inline;\'>See SUD Assessment dated <div class=\'entry\' style=\'display:inline\'><button>Click to Enter Date</button></div> by <div class=\'entry\' style=\'display:inline\'><button>Click to Enter Name</button></div>, <div class=\'entry\' style=\'display:inline\'><button>Click to Enter Credential(s)</button></div>.</div></em>';
